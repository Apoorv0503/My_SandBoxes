...
function generateCard(id, fullName, jobTitle, bio, avatar) {
  ...
  let imgelement = getImageElement(avatar, fullName);
  ...
  const headerjobTitle = document.createElement("h3");
  headerjobTitle.textContent = jobTitle;
  ...
  div.append(headerfullName, headerjobTitle, parabio);
