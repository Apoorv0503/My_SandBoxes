class GitHub {
  constructor() {
    ...
    // we are passing this.getUserDetails as callback in addEventListener() and
    // when we pass the method as callback,
    // the value of this is lost and when the executor function executes the callback,
    // this is not pointing to the object of GitHub class anymore.
